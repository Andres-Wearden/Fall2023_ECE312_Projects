...
//bool isSubsetOfDebug(const Set* self, const Set* other) {
//    printf("I AM HERE HAHAHAHAHAHA\n");
...
//        printf("%d\n\n", self->len);
//        printf("%d\n\n", other->len);
//        printf("Condition is wrong");
//        return (j == self->len);
//    }else{
//        printf("self->len > other->len");
//        return false;
//    }
//}
//
...
//    insertSet(&s, 72);
//    insertSet(&s, 81);
//    for(int i = 0; i < maximum_set_size; i++){
...
//        if(isSubsetOf(&s, &universal) == false){
//            displaySet(&s);
//            isSubsetOfDebug(&s, &universal);
//            printf("\n\n\n");
//            displaySet(&universal);
//            printf("\n\n\n");
//            printf("%d\n\n", loop);
//        }
//        loop++;
